            ...
            {!loading && datos && (
                <div className="grid grid-cols-2 gap-8 items-center">
                    ...
                    <div className="relative w-full rounded-2xl overflow-hidden shadow-[0_0_3px_#a855f7] hover:shadow-[0_0_5px_#a855f7] transition-all duration-750    border border-white/10 group">
                        <img src={datos.url} alt={datos.title} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />

                        {/* Overlay Gradiente */}
                        <div className="absolute bottom-0 left-0 w-full h-1/2 bg-gradient-to-t from-black via-black/70 to-transparent flex flex-col justify-end p-6">
